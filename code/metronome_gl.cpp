...
void gl_init (gui_window window) {
	...
	the_shader_color = load_shader ("W:\\metronome\\data\\shaders\\color.vert",
									"W:\\metronome\\data\\shaders\\color.frag", window);
	the_shader_texture = load_shader ("W:\\metronome\\data\\shaders\\texture.vert",
									  "W:\\metronome\\data\\shaders\\texture.frag", window);
